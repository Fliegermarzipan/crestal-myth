  ...
  class LD < Opcode
    def call(cpu) : Bool
      ...
      when Component::Reg8Mem
        target_reg = false
        target = 0xFF00_u16 + cpu.ram.read(cpu.reg.read(Component::Reg8.new(@args[0].as(Component::Reg8Mem).value)))
      ...
      when Component::Reg8Mem
        value = 0xFF00_u16 + cpu.ram.read(cpu.reg.read(Component::Reg8.new(@args[1].as(Component::Reg8Mem).value)))
      when Component::Reg16Mem
